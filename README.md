...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/damp-smoke-a8e7)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/damp-smoke-a8e7
```

A live public deployment of this template is available at [https://damp-smoke-a8e7.templates.workers.dev](https://damp-smoke-a8e7.templates.workers.dev)
